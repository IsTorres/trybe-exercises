...
function sendMarsTemperatureA(getMarsTemp) {
  setTimeout(() => console.log(`Mars temperature is: ${getMarsTemp} degree Celcius`), messageDelay());
}

sendMarsTemperatureA(getMarsTemperature()); // imprime "Mars temperature is: 20 degree Celsius", por exemplo
...
function sendMarsTemperature(getMarsTemp) {
  setTimeout(() => getMarsTemp(toFahrenheit(getMarsTemperature())), messageDelay()); // Encapsula 3 funções
}
